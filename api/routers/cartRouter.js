...
router.post('/:userId/items/total', async (req, res) => {
    try {
        const response = await cartService.post(`/carts/${req.params.userId}/items/total`, req.body)
...
router.post('/:userId/addItem', async (req, res) => {
    try {
        const response = await cartService.post(`/carts/${req.params.userId}/addItem`, req.body)
...
router.patch('/:userId/:itemId', async (req, res) => {
    try {
        ...
        const response = await cartService.patch(`/carts/${userId}/${itemId}`, req.body)
