...
router.post('/:id/variant', authMiddleware, async (req, res) => {
    try {
        const response = await productService.post(`/products/${req.params.id}/variant`, req.body)
...
router.patch('/:id', authMiddleware, async (req, res) => {
    try {
        const response = await productService.patch(`/products/${req.params.id}`, req.body)
