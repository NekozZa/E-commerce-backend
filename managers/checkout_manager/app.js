...
app.post('/checkout', authMiddleware, async function (req, res) {
    const { deliveryAddress, items, couponId = undefined, callbackURL } = req.body
    ...
    const result = await controller.checkoutOrder(token, ipAddress, callbackURL, deliveryAddress, items, couponId)
