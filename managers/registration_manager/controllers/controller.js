...
const register = async (email, callbackURL) => {
    try {
        const password = await authClient.getPassword(email)
        ...
        return { status: 500, data: "Registration Manager: Can't communicate with clients" }
    }
}
